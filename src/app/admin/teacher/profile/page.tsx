  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center gap-5">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold text-2xl flex-shrink-0 shadow-lg">
          {initials || <UserCircle className="w-10 h-10" />}
        </div>
        <div>
          <p className="text-xl font-bold text-slate-800">{fullName || 'Teacher'}</p>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium text-slate-700 focus:ring-2 focus:ring-amber-500 outline-none transition-all"
          />
        </div>
        ...
        <button
          onClick={saveProfile}
          disabled={saving}
          className="flex items-center gap-2 bg-amber-600 hover:bg-amber-700 disabled:bg-amber-200 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors"
        >
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="••••••••"
            className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-amber-500 transition-all text-ink"
          />
        </div>
        <div>
