        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="col-span-full">
              ...
              <input type="text" name="name" defaultValue={cls.name} required className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
            </div>

            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Program Type *</label>
              <select name="programType" defaultValue={cls.program_type} required className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white">
            ...
            <div>
              ...
              <select name="teacherId" defaultValue={cls.teacher_id || ''} className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white">
            ...
            <div>
              ...
              <select name="genderRequirement" defaultValue={cls.gender_requirement || 'both'} required className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white">
          ...
          <div>
            ...
            <input type="text" name="time" defaultValue={cls.schedule_time || ''} className="w-full md:w-1/2 px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. 5:00 PM - 7:00 PM" />
          </div>
