    ...
    <div className="min-h-screen flex flex-col items-center w-full">
      ...
      <section className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 md:-mt-20 relative z-20 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link href="/programs#vocational" className="bg-white hover:bg-amber-50 rounded-lg shadow-xl overflow-hidden flex flex-col items-center text-center border-b-4 border-amber-600 hover:-translate-y-2 transition-all duration-300 cursor-pointer group block">
            <div className="relative w-full h-32 sm:h-40 bg-slate-100 overflow-hidden">
          ...
          <Link href="/programs#youth" className="bg-white hover:bg-amber-50 rounded-lg shadow-xl overflow-hidden flex flex-col items-center text-center border-b-4 border-amber-600 hover:-translate-y-2 transition-all duration-300 cursor-pointer group block">
            <div className="relative w-full h-32 sm:h-40 bg-slate-100 overflow-hidden">
